...
export interface ShowcaseSliceDefaultPrimary {
	...
	/**
	 * Subeading field in *Showcase → Default → Primary*
	 *
	 * - **Field Type**: Title
	 * - **Placeholder**: *None*
	 * - **API ID Path**: showcase.default.primary.subeading
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	subeading: prismic.TitleField;
...
export interface ShowcaseSliceReversePrimary {
	...
	/**
	 * Subeading field in *Showcase → Reverse → Primary*
	 *
	 * - **Field Type**: Title
	 * - **Placeholder**: *None*
	 * - **API ID Path**: showcase.reverse.primary.subeading
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	subeading: prismic.TitleField;
